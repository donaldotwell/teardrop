...
@section('page-title', 'Cards — My Bases')
...
<div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Cards Autoshop</h1>
            <p class="text-sm text-gray-500 mt-1">Upload pipe-delimited card files and sell to buyers.</p>
        </div>
        <a href="{{ route('vendor.cards.create') }}"
    ...
    @if($bases->isEmpty())
        <div class="bg-white border border-gray-200 rounded-xl p-12 text-center">
            <p class="text-gray-500 mb-4">You have not uploaded any card bases yet.</p>
            <a href="{{ route('vendor.cards.create') }}"
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 border-b border-gray-200">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right font-semibold text-gray-700">Price/Card</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3 font-medium text-gray-900">
                            <a href="{{ route('vendor.cards.show', $base) }}" class="hover:text-purple-700">
                                {{ $base->name }}
                            </a>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center justify-center gap-2">
                                <a href="{{ route('vendor.cards.show', $base) }}"
                                   class="text-xs text-purple-700 hover:underline">View</a>

                                <form action="{{ route('vendor.cards.toggle', $base) }}" method="POST" class="inline">
                                    @csrf
                                ...
                                <form action="{{ route('vendor.cards.destroy', $base) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
