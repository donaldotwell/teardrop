...
@section('breadcrumbs')
    ...
    <span class="text-amber-700">Create Post</span>
@endsection
...
@section('content')
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
            <h3 class="font-semibold text-yellow-800 mb-2">Forum Rules</h3>
            <ul class="text-sm text-yellow-700 space-y-1">
                <li>• No links or URLs are allowed in posts or comments</li>
                <li>• Be respectful and constructive in your discussions</li>
                <li>• No spam, self-promotion, or off-topic content</li>
                <li>• No personal attacks or harassment</li>
                <li>• Posts promoting illegal activities will result in immediate ban</li>
                <li>• Misleading or sponsored content will result in account suspension</li>
            </ul>
        </div>

        <form action="{{ route('forum.posts.store') }}" method="POST" class="space-y-6">
            @csrf
