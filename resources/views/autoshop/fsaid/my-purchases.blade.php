...
@section('page-title', 'My FSAID Purchases — Autoshop')
@section('page-heading', 'My FSAID Purchases')

@section('breadcrumbs')<span>My FSAID Purchases</span>@endsection

@section('content')

    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 mb-5">
        <p class="text-sm text-gray-500">Click a purchase to view full record details.</p>
        <a href="{{ route('autoshop.fsaid.index') }}" class="text-sm text-teal-700 hover:underline sm:ml-4">Browse FSAID</a>
    </div>

    @if($purchases->isEmpty())
        <div class="bg-white border border-gray-200 rounded-xl p-12 text-center">
            <p class="text-gray-500 mb-4">You have not purchased any FSAID records yet.</p>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-teal-50 transition-colors">
                        ...
                        <td class="px-4 py-3 text-right">
                            <a href="{{ route('autoshop.fsaid.receipt', $p) }}"
