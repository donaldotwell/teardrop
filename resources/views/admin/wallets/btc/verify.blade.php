...
@section('page-title', 'Verify BTC Transfer')
    ...
    <div class="max-w-2xl space-y-6">
        ...
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
            ...
            <div class="space-y-1 text-sm text-amber-800">
                <div><strong>From:</strong> {{ $btcWallet->name }}</div>
                <div><strong>To:</strong> <span class="font-mono text-xs break-all">{{ $address }}</span></div>
                <div><strong>Amount:</strong> <span class="font-mono font-bold">{{ $amount }} BTC</span></div>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <form action="{{ route('admin.wallets.btc.transfer-execute', $btcWallet) }}" method="POST" class="space-y-4">
                @csrf
