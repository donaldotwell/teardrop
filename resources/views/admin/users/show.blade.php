            ...
            @if($user->pgp_pub_key)
                <div class="flex items-center justify-between gap-4">
                    ...
                    <x-modal
                        ...
                        triggerClass="flex-shrink-0 px-4 py-2 bg-yellow-600 text-white text-sm font-medium rounded-lg hover:bg-yellow-700 transition-colors"
                    >
                        <div class="space-y-3">
            ...
            <div class="bg-white border border-gray-200 rounded-lg p-6">
                ...
                @if($user->hasRole('vendor'))
                    <div class="pt-4 border-t border-gray-100">
                        <form action="{{ route('admin.users.strip-vendor', $user) }}" method="POST">
                            @csrf
                            <button type="submit"
